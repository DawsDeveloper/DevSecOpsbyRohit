...
```
 ...
 Notes
-P is useful when you don’t want to hardcode host ports.
Use docker inspect appserver for detailed port and network info.
Use docker logs appserver if you want to troubleshoot Nginx logs.
