...
7. Listing important Docker commands  
8. `docker run` options and usage  
9. Downloading images and creating containers  
10. Stopping and removing containers  
11. Understanding Detached Mode (`-d`) vs Interactive Mode (`-it`)  
12. Using environment variables in containers
